...
public class SelectionSortPerformanceTest {
    ...
    public void should_saveSortingTimeToTheFile_when_sortingOptimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/selectionSort/selectionSortOptimistic.txt";
    ...
    public void should_saveSortingTimeToTheFile_when_sortingAverageCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/selectionSort/selectionSortAverage.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
