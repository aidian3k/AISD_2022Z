...
public class HeapSortPerformanceTest {
    ...
    public void should_saveSortingTimeToTheFile_when_sortingOptimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/heapSort/heapSortOptimistic.txt";
    ...
    public void should_saveSortingTimeToTheFile_when_sortingAverageCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/heapSort/heapSortAverage.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
    ...
    public void should_saveSortingTimeToTheFile_when_sortingPessimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/heapSort/heapSortPessimistic.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
