...
public class RefSortPerformanceTest {

    private final int SEED = 1000;
    private final int MAX_ELEMENTS_TO_SORT = 250_000;
    private final int NUMBER_OF_TIMES_TO_REPEAT = 5;
    ...
    public void setUpSortingTests() {
        sortingMethod = new RefAlgorithm();
    }
    ...
    public void setUpOptimisticCase() {
        ...
        performanceUtils.generateQuickSortBestCase(optimisticArray);
    ...
    public void setUpPessimisticCase() {
        ...
        pessimisticArray = performanceUtils.createRandomArray(currentLength, randomNums);
    ...
    public void should_saveSortingTimeToTheFile_when_sortingOptimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/refSort/refSortOptimistic.txt";
    ...
    public void should_saveSortingTimeToTheFile_when_sortingAverageCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/refSort/refSortAverage.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
    ...
    public void should_saveSortingTimeToTheFile_when_sortingPessimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/refSort/refSortPessimistic.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
