...
public class QuickSortPerformanceTest {
    ...
    public void should_saveSortingTimeToTheFile_when_sortingOptimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/quickSort/quickSortOptimistic.txt";
    ...
    public void should_saveSortingTimeToTheFile_when_sortingAverageCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/quickSort/quickSortAverage.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
    ...
    public void should_saveSortingTimeToTheFile_when_sortingPessimisticCase() throws IOException {
        String filePath = "src/test/java/pl/edu/pw/ee/PerformanceTests/TimeData/quickSort/quickSortPessimistic.txt";
        PrintWriter pw = new PrintWriter(new FileWriter(filePath));
